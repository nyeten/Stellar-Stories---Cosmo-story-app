...
public class CME {  
    ...
    public void initialize() {
        ...
        slides.setImage(new Image(getClass().getResource("/images/space.png").toExternalForm()));
        foreground.setImage(new Image(getClass().getResource("/images/shuttle.png").toExternalForm()));
